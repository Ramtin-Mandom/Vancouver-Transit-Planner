...
def c(
    name: str, kind: Any = "text", nullable: bool = True, source: str | None = None
) -> Column:
...
TABLES: tuple[TableSpec, ...] = (
    TableSpec(
        ...
        "agency.txt",
        (
            c("agency_id", nullable=False),
            c("agency_name", nullable=False),
            c("agency_url", nullable=False),
            c("agency_timezone", nullable=False),
            c("agency_lang"),
            c("agency_phone"),
            c("agency_fare_url"),
        ),
    ...
    TableSpec(
        ...
        (
            c("service_id", nullable=False),
            c("service_date", "date", False, "date"),
    ...
    TableSpec(
        ...
        "feed_info.txt",
        (
            c("feed_publisher_name", nullable=False),
            c("feed_publisher_url", nullable=False),
            c("feed_lang", nullable=False),
            c("feed_start_date", "date"),
            c("feed_end_date", "date"),
            c("feed_version"),
        ),
    ),
    TableSpec(
        ...
        "routes.txt",
        (
            c("route_id", nullable=False),
            c("agency_id", nullable=False),
            c("route_short_name"),
            c("route_long_name"),
            c("route_desc"),
            c("route_type", "integer", False),
            c("route_url"),
            c("route_color"),
            c("route_text_color"),
        ),
    ...
    TableSpec(
        ...
        "stops.txt",
        (
            c("stop_id", nullable=False),
            c("stop_code"),
            c("stop_name", nullable=False),
            c("stop_desc"),
            c("stop_lat", "decimal"),
            c("stop_lon", "decimal"),
            c("zone_id"),
            c("stop_url"),
            c("location_type", "integer"),
            c("parent_station"),
    ...
    TableSpec(
        ...
        "shapes.txt",
        (
            c("shape_id", nullable=False),
            c("shape_pt_lat", "decimal", False),
            c("shape_pt_lon", "decimal", False),
            c("shape_pt_sequence", "integer", False),
    ...
    TableSpec(
        ...
        (
            c("route_id", nullable=False),
            c("service_id", nullable=False),
            c("trip_id", nullable=False),
            c("trip_headsign"),
            c("trip_short_name"),
            c("direction_id", "integer"),
            c("block_id"),
            c("shape_id"),
            c("wheelchair_accessible", "integer"),
            c("bikes_allowed", "integer"),
        ),
    ),
    TableSpec(
        "stop_times",
        ...
        (
            c("trip_id", nullable=False),
            c("arrival_time", "interval"),
            c("departure_time", "interval"),
            c("stop_id", nullable=False),
            c("stop_sequence", "integer", False),
            c("stop_headsign"),
            c("pickup_type", "integer"),
            c("drop_off_type", "integer"),
            c("shape_dist_traveled", "decimal"),
            c("timepoint", "integer"),
        ),
    ),
    TableSpec(
        ...
        "transfers.txt",
        (
            c("from_stop_id", nullable=False),
            c("to_stop_id", nullable=False),
            c("transfer_type", "integer", False),
            c("min_transfer_time", "integer"),
            c("from_trip_id"),
            c("to_trip_id"),
        ),
    ),
    TableSpec(
        ...
        "translations.txt",
        (
            c("table_name", nullable=False),
            c("field_name", nullable=False),
            c("language", nullable=False),
            c("translation", nullable=False),
    ...
    TableSpec(
        ...
        "signup_periods.txt",
        (
            c("sign_id", nullable=False),
            c("from_date", "date", False),
    ...
    TableSpec(
        ...
        (
            c("route_name", nullable=False),
            c("direction_id", "integer", False),
            c("direction_name", nullable=False),
            c("direction_do", "integer", False),
        ),
    ),
    TableSpec(
        "directions",
...
class TransitLoader:
    ...
    def _validate_paths(self) -> None:
        ...
        missing = [
            spec.filename
            for spec in TABLES
            if not (self.data_dir / spec.filename).is_file()
        ]
        if missing:
    ...
    def load(self, *, replace: bool = False) -> LoadSummary:
        ...
        successful: dict[str, int] = {}
        with (
            connect(**self.config.connection_kwargs()) as connection,
    ...
    def _ensure_schema_tables(connection: Connection[Any]) -> None:
        ...
        if missing:
            raise RuntimeError(
                "Required transit tables do not exist: "
                + ", ".join(missing)
